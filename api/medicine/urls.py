...
from .views import CureViewSet, ScheduleViewSet, TimeTableViewSet,MainView,TimeTableView,CollectStatisticView,TakeViewSet
...
urlpatterns = [
    ...
    # path('take/', Tak eViewSet.as_view()),
